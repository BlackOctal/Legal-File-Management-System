    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {categoryConfig.map((category) => (
          ...
          >
            <div
              className={`${category.color} border-2 rounded-xl p-6 transition duration-200`}
            >
              <div className="flex items-start justify-between mb-4">
                <div
                  className={`w-12 h-12 flex items-center justify-center ${category.iconColor} bg-white rounded-lg`}
                >

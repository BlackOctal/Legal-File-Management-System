...
export default function CreateCasePage() {
  ...
  const [categories] = useState([
    { 
      ...
      subcategories: [
        { _id: 'loan-settlement', name: 'Loan Settlement' },
        { _id: 'debt-recovery', name: 'Debt Recovery' },
        { _id: 'bankruptcy', name: 'Bankruptcy' }
      ]
    },
    { 
      _id: 'deeds',
      ...
      name: 'Property Deeds', 
      subcategories: [
        { _id: 'property-transfer', name: 'Property Transfer' },
        { _id: 'title-dispute', name: 'Title Dispute' },
    ...
    { 
      ...
      subcategories: [
        ...
        { _id: 'prosecution', name: 'Prosecution' },
        { _id: 'appeals', name: 'Appeals' }
      ]
    },
    { 
      _id: 'civil',
      ...
      subcategories: [
        { _id: 'contract-dispute', name: 'Contract Dispute' },
        { _id: 'personal-injury', name: 'Personal Injury' },
        { _id: 'torts', name: 'Torts' }
      ]
    },
    { 
      _id: 'family',
      ...
      name: 'Family Law', 
      subcategories: [
        { _id: 'divorce', name: 'Divorce' },
        { _id: 'custody', name: 'Custody' },
        { _id: 'adoption', name: 'Adoption' }
      ]
    },
    { 
      _id: 'corporate',
      ...
      name: 'Corporate Law', 
      subcategories: [
        { _id: 'formation', name: 'Formation' },
        { _id: 'contracts', name: 'Contracts' },
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const caseData = {
        ...
        clientNames: formData.clientNames.filter(name => name.trim() !== '').map(name => name.trim()),
        description: formData.description.trim(),
        priority: formData.priority,
        assignedLawyer: formData.assignedLawyer.trim(),
        courtName: formData.courtName.trim(),
        judgeAssigned: formData.judgeAssigned.trim()
      };
      ...
      const newCaseId = result.data?.case?._id || result.data?.case?.id;
  ...
  const selectedCategory = categories.find(cat => 
    cat.identifier === formData.category || cat._id === formData.category
  );
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="border-b border-gray-200 pb-6">
              <h3 className="text-lg font-medium text-gray-900 mb-4">Case Reference Information</h3>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                  ...
                  />
                  <p className="text-xs text-gray-500 mt-1">Any format accepted</p>
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">
                  ...
                  <input
                    ...
                    maxLength={50}
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    placeholder="Enter any file number"
                ...
                <div>
                  ...
                  <input
                    ...
                    maxLength={50}
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    placeholder="Enter any case number"
            ...
            <div>
              ...
              <div className="space-y-6">
                  ...
                  <div>
                    ...
                    >
                      ...
                      {categories.map((category) => (
                        <option key={category._id || category.identifier} value={category.identifier || category._id}>
                          {category.name}
                        </option>
                      ))}
                    </select>
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">
                    Client Names <span className="text-red-500">*</span>
                  </label>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      Assigned Lawyer <span className="text-red-500">*</span>
                    </label>
                    <input
                      type="text"
                      required
            ...
            <div className="flex items-center justify-end space-x-4 pt-6">
              <Link href="/cases" className="px-6 py-3 text-gray-700 bg-gray-100 hover:bg-gray-200 rounded-lg font-medium transition duration-200 whitespace-nowrap cursor-pointer">
                Cancel
              </Link>
              <button
                type="submit"
